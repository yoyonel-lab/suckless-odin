...
test_session_save_load :: proc(t: ^testing.T) {
	...
	testing.expect_value(t, loaded_state.volumetric.sun_color, mt.Vec3{1.2, 0.9, 0.6})
	testing.expect_value(t, loaded_state.volumetric.sun_color_auto, true)
