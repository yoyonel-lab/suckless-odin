...
ITT_ENABLE :: #config(ITT_ENABLE, false)
...
// Zero-overhead when VTune is not running or compile-time disabled; dynamically resolves symbols at runtime.
...
task_begin :: #force_inline proc(name: string) {
	when ITT_ENABLE {
