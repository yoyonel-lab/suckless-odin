...
Dans le fichier [.env](../.env), les variables requises pour le PRIME Render Offload d'NVIDIA et le débrayage du VSync sont absentes :
```env
...
| :--- | :--- | :--- |
| **Offloading GPU** | Compléter le fichier [.env](../.env) avec les variables PRIME d'Nvidia. | Transition immédiate sur la GTX 950M (+300% FPS). |
